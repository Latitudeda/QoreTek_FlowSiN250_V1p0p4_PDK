...
Extract the ``QoreTek_FlowSiN_250_V1p0p4_Latitudeda`` zip archive and copy it to the workspace folder. As shown in the figure below, the ``QoreTek_FlowSiN_250_V1p0p4_Latitudeda`` folder is in the demo folder and parallel to .venv_demo_QoreTek_FlowSiN250.
