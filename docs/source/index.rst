QoreTek FlowSiN 250 PDK documentation
====================================
.. image:: ./images/LDA_LOGO_WIDE.png
   :width: 100%
   :align: center

This documentation outlines the contents and usage of the **Latitudeda PDK** for **QoreTek FlowSiN 250** (v1.0.4).

The PDK is compatible with **PhotoCAD** and **Advanced SDL** for layout generation. Key features and capabilities include:

- Designing custom components using the defined layers from **QoreTek FlowSiN 250**.
