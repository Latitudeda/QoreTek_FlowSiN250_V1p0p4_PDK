Install PhotoCAD and QoreTek FlowSiN 250 V1p0p4 PDK
=======================================
...
To install **QoreTek FlowSiN 250 V1p0p4 PDK** package to **PhotoCAD**, extract ``QoreTek_FlowSiN_250_V1p0p4_Latitudeda_Customer.zip`` to the project folder.
